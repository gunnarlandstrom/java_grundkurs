 ...
 * (get) information om personen. Metoden setName utan parameterar
 * har lagts till i vilken två dialogrutor används för att fråga
 * efter personens för- och efternamn.
 *
...
public class Person3 {
    ...
    */
    ...
    // Denna överlagrade metod av setName tar inga parametrar utan använder
    // två dialogrutor för att fråga efter för- och efternamn på personen.
    public void setName() {
