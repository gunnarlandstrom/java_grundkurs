 ...
 * av klassen.
 *
 * Metoden toString har överskuggats för att returnera en
 * sträng som "representerar" klassen på ett lämpligt sätt.
 *
...
public class Person6 {
    ...
    public Person6(String firstName, String lastName, int age, String mail) {
    ...
    public Person6(String firstName, String lastName, int age) {
    ...
    */
    ...
    /* Metod som returnerar en strängrepresentation av objektet.
       Vi har valt att returnera för- och efternamn på personen
       och utnyttjar metoden getName som redan formaterar namnet
       på detta sätt. Vi hade kunnat välja ett annat sätt att
       representera ett Person-objekt.
    */
